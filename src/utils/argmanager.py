...
def update_scoring_args(parser):
    ...
    parser.add_argument("-f16", "--float16", action='store_true', help="Output profiles in float16 format")
    parser.add_argument('--multiGPU', default=False, action='store_true', help="Use multiple GPUs for predictions.")
